...
# Save integration test script
with open('phishing-detector/tests/integration_tests.py', 'w') as f:
    f.write(integration_test_code)

print("✅ Phase 6: Integration test script created!")
print("📄 File: phishing-detector/tests/integration_tests.py")