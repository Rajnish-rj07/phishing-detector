...
# Data collection from PhishTank and sample legitimate URLs
data_collector_code = '''
import requests
import pandas as pd
import json
...
# Save the data collector script
with open('phishing-detector/src/data_collector.py', 'w') as f:
    f.write(data_collector_code)

print("✅ Phase 1: Data collection script created!")
print("📄 File: phishing-detector/src/data_collector.py")